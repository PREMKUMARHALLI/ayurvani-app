export { api, useAuth, useLanguage, useLLM } from "./AppImpl";
export { default } from "./AppImpl";
/* import React, { useState, useEffect, createContext, useContext } from "react";
import { Routes, Route, Navigate, useNavigate } from "react-router-dom";
import axios from "axios";
import { Toaster } from "sonner";
import { translations, getTranslation, languageNames, suggestedQuestions, aiGreetings } from "./translations";
...
const LanguageProvider = ({ children }) => {
  ...
  return (
    <LanguageContext.Provider
      value={{ language, setLanguage, t, translations, languageNames, getSuggestedQuestions, getAiGreeting }}
    >
      {children}
    </LanguageContext.Provider>
  );
